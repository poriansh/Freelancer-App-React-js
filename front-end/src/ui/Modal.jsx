  ...
  return (
    open && (
      <div className="backdrop-blur-sm fixed inset-0 bg-secondary-800/30 z-50 flex items-center justify-center">
        <div ref={ref} className="fixed bg-secondary-0 rounded-lg shadow-lg transition-all p-3 w-[calc(100vw-2rem)]  sm:max-w-md max-h-[calc(100vh-2rem)] overflow-y-auto">
